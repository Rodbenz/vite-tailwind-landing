    ...
    return (
        ...
        <div className='bg-gradient-to-t from-gray-300'>
            <div className='container mx-auto flex  items-center py-16'>
                ...
                <div className='w-1/2'>
                    <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=80&w=1770&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="development" className='w-full rounded-2xl translate hover:translate-y-1 hover:scale-110' />
                </div>
            </div>
        </div>
    )
